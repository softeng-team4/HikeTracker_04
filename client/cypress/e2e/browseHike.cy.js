describe('Browse Hikes', () => {
  ...
  it("Select ascent and time", () => {
    ...
    cy.get(".card").should("have.length", 4)
    cy.get(':nth-child(4) > .card > .card-footer > .row > :nth-child(3)').contains(/([4-9]\d\d|[1-9]+\d+\d\d) m/)
    cy.get(':nth-child(5) > .card > .card-footer > .row > :nth-child(3)').contains(/([4-9]\d\d|[1-9]+\d+\d\d) m/)
    cy.get(':nth-child(6) > .card > .card-footer > .row > :nth-child(3)').contains(/([4-9]\d\d|[1-9]+\d+\d\d) m/)
    cy.get(':nth-child(7) > .card > .card-footer > .row > :nth-child(3)').contains(/([4-9]\d\d|[1-9]+\d+\d\d) m/)
    cy.get(':nth-child(4) > .card > .card-footer > .row > :nth-child(4)').contains(/(2[4-9]\d|3\d\d|4[0-7]\d|480) min/)
    cy.get(':nth-child(5) > .card > .card-footer > .row > :nth-child(4)').contains(/(2[4-9]\d|3\d\d|4[0-7]\d|480) min/)
    cy.get(':nth-child(6) > .card > .card-footer > .row > :nth-child(4)').contains(/(2[4-9]\d|3\d\d|4[0-7]\d|480) min/)
    cy.get(':nth-child(7) > .card > .card-footer > .row > :nth-child(4)').contains(/(2[4-9]\d|3\d\d|4[0-7]\d|480) min/)
