        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='/' element={<AppLayout />} >
              ...
              <Route path='completedHikes' element ={authUser && (authUser.role.toLowerCase() === 'hiker') ? <CompletedHikes /> : <Navigate to='/ ' />} />
              <Route path='huts' element={authUser ? <BrowserHuts /> : <Navigate to='/' />} />
